...
func set_terrain_painter(terrain_painter: HT_TerrainPainter):
	...
	if _terrain_painter != null:
		...
		var default_shape_fpath: String = HT_Brush.DEFAULT_BRUSH_TEXTURE_PATH
...
func set_display_mode(mode: int):
	var show_flatten: bool = mode == HT_TerrainPainter.MODE_FLATTEN
	var show_color: bool = mode == HT_TerrainPainter.MODE_COLOR
	var show_density: bool = mode == HT_TerrainPainter.MODE_DETAIL
	var show_opacity: bool = mode != HT_TerrainPainter.MODE_MASK
	var show_holes: bool = mode == HT_TerrainPainter.MODE_MASK
	var show_slope_limit: bool = mode == HT_TerrainPainter.MODE_SPLAT
